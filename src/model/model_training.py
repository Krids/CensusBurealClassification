"""
This file is responsible for the training for the
model on the Census Bureal Data.
...
class ModelTraining:
    ...
    def get_trained_model(self,
        ...
        Args:
            ...
            Defaults to os.path.join(MODELS_PATH, "gbclassifier.pkl").
    ...
    def execute(self):
        ...
        (train_precision,
         train_recall,
         train_fbeta) = self.compute_model_metrics(
            y_train, y_train_pred)
        log.info("train_precision: {train_precision}, \
                train_recall: {train_recall}, \
                train_fbeta: {train_fbeta}".format(
        ...
        (test_precision,
         test_recall,
         test_fbeta) = self.compute_model_metrics(
            y_test, y_test_pred)
        log.info("test_precision: {test_precision}, \
            test_recall: {test_recall}, \
                test_fbeta: {test_fbeta}".format(
